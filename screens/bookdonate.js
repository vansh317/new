...
import { View, StyleSheet, Text, TextInput, TouchableOpacity, Modal, ScrollView, KeyboardAvoidingView, Alert, FlatList } from 'react-native';
...
const styles = StyleSheet.create({
    subContainer: {
        flex: 1, fontSize: 20, justifyContent: 'center',
        alignItems: 'center'
    },
    button: {
        width: 100, height: 30,
